...
class Transformer(nn.Module):
    ...
    def forward(self, inputs: torch.Tensor, ignore_index=-1):
...
if __name__ == "__main__":
    ...
    tokenizer_path = "/home/jacob/.llama/checkpoints/Llama3.2-1B/1tokenizer.model"
    modelpath = ckpt_dir+"/1consolidated.00.pth"
    ...
    prompts= ["Toxicity : 80;", "Toxicity : 90;", "Toxicity : 0;", "Toxicity : -80;" ]
    ...
    print(tokenizer.encode("To",eos=False,bos=False))
    exit()
